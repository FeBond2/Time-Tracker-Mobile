...
# Email (for password reset). Set EMAIL_HOST, EMAIL_HOST_USER, EMAIL_HOST_PASSWORD in production.
if os.environ.get("EMAIL_HOST"):
    ...
    DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", EMAIL_HOST_USER or "noreply@timetracker.app")
else:
    EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"
    DEFAULT_FROM_EMAIL = "noreply@timetracker.app"
