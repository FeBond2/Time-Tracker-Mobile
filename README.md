# Time Tracker Backend (Django)

- **Python 3.10+** recommended. Create a venv and install: `pip install -r requirements.txt`
...
- For the mobile app, the device must reach your API over HTTPS; set the app’s API URL to your backend base URL (see root README).
